...
class DemandeEmbauche extends DemandeForm
{
     ...
     * @var string
     *
     * @ORM\Column(name="remplacement_date", type="datetime", length=255)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="remplacement_date2", type="datetime", length=255)
     */
     ...
     * @var array
     *
     * @ORM\Column(name="temps_partiel", type="json_array")
     */
